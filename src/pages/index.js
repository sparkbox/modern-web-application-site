...
const IndexPage = () => (
  <Layout>
    ...
    <section>
      ...
      <hr />
      <p>The definition of a modern development environment is constantly changing. We’re moving towards more modular, performant, and resilient architectures when crafting our web applications. Let’s break these three higher-level goals down to create a list of criteria that each of our environments can maintain to be considered “modern”.</p>
