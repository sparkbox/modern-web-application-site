...
const WorkshopPage = () => (
  <Layout>
    ...
    <p>
      <q>Let’s face it, sometimes setting up a new application seems daunting. It doesn’t have to be. We’ll show you what goes on behind the scenes as we navigate different languages and frameworks and get comfortable with the idea of a brand new codebase.</q>
    </p>
    ...
    <h2>Workshop Languages and Frameworks</h2>
    <ul>
